module.exports = app => {
  ...
  router.get('/searchTitle/:searchWord/:sortype/:ordertype', tutorials.searchTitle);

  router.get('/searchDescription/:searchWord/:sortype/:ordertype', tutorials.searchDescription);
